var DeployWrapper = React.createClass({displayName: "DeployWrapper",
        ...
        if(this.state.submitted == true) {
            ...
            return (
                React.createElement("div", null, 
                    ...
                    "Contract does not exist on the blockchain. ", React.createElement("button", {className: "btn btn-default", onClick: this.deployContract}, "Deploy Contract ", this.props.name)
                )
            );
        }
    }
